...
class Modelo:
    ...
    def inicializar_objetos_modelo(self):
        ...
        titulos_vectores_muestras = ["Voltaje","Frecuencia", "Tiempo"]
        param_muestras = {'numMuestras': 320, 'numCanales': len(titulos_vectores_muestras),
        ...
        titulos_marcadores_display = {'m0': "Voltaje en el tiempo",        
                                      'm1': "Valores de la senal",
                                      'm2': "Diagrama de Estados",
                                      'm3': "Diagrama Electronico"}
        ...
        # --- Trazador de curvas para circuito DDS
        graf.graficar_curvas_DDS()
