...
#       - Clase: Calculadora_datos-graficas   <-- Auxiliar que calcula diversas coordenadas, variables y parametros
#       - Clase: FSM          <-- Define la maquina de estados a estudiar
#
# Fecha: julio 28/2021
#
# ************************************
...
class Modelo:
    ...
    def inicializar_objetos_modelo(self):
        ...
        titulos_vectores_muestras = ["salida","entrada"]
        param_muestras = {'numMuestras': 16, 'numCanales': len(titulos_vectores_muestras),
        ...
        titulos_marcadores_display = {'m0': "Senales combin.",
                                      'm1': "Tabla de verdad",
                                      'm2': "Solución"}
        ...
        # --- Trazador de curvas FSM
        # Revisar tanto m/FSM.py como ARDUINO que contengan la
        # misma maquina de estados
        # -------------------------------------------------------
        graf.graficar_curvas_FSM()    # 4 marcadores 4 graficas
