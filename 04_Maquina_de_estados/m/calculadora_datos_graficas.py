...
class calculadora_datos_graficas:
    ...
    # 1. Encontrar las intersecciones entre la circunferencia del estado actual y la linea que une los centros de la circunferencia actual y a la que es de transicion. 
    # 2. Calcular la recta perpendicular a la anterior y sobre el punto de interseccion.
    ...
    #   Hay dos casos especiales que son que la pendiente de la recta del punto 1 sea horizontal o vertical:
    #   a. Cuando m tiende a infinito, se calcula las coordenadas de los puntos que equidistan de la interseccion del punto 1 y se ubican sobre la resta perepndicular
    #   b. Si m no tienda a infinito o m es igual a cero, se utiliza un metodo mas sencillo. Se toma la interseccion del punto 1 como centro de una nueva circunferencia
    ...
    #   Hay dos casos especiales que igual son dependiendo de la pendiente de la recta del punto 1 si es horizontal o vertial:
    #   a. Cuando m tiende a infinito, se realiza el mismo procedimiento descrito en los puntos 1, 2 y 3.a, esta vez con la circunferencia de transicion. 
    #   b. Si m no tiende a infinito, se calcula la ecuacion que una las circunferencias del estado actual y la de transicion en los puntos calculados en el punto 3
    ...
    # -------------------------------------------------------
    # Calcula el punto medio dadas dos coordenadas. 
    # 
    # -------------------------------------------------------
    def punto_medio_entre_dos_coordenadas(self,c1,c2):
        if c1 < c2:
            c_lb = c1 + (c2 - c1)/2
        elif c1 > c2:
            c_lb = c2 + (c1 - c2)/2
    ...
    def obtener_coordenadas_labels(self,p1,p2):
        ...
        x_lb = self.punto_medio_entre_dos_coordenadas(xp1,xp2)
        y_lb = self.punto_medio_entre_dos_coordenadas(yp1,yp2)
